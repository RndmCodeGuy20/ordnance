...
- String → treat as branch name directly
...
Submodules synced: <sha list or "none">
```

## Rules
- Never do both worktree add AND branch switch — pick one path only.
- Always run `git submodule update --init --recursive` in branch-switch mode.
